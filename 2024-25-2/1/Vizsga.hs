...
t2 = Node (Just $ Node (Just $ Node Nothing 'h' Nothing) 'e' (Just $ Node Nothing 'l' Nothing)) 'l' (Just $ Node (Just $ Node Nothing 'o' Nothing) ' ' (Just $ Node (Just $ Node Nothing 'w' Nothing) 'o' (Just $ Node (Just $ Node Nothing 'r' Nothing) 'l' (Just $ Node Nothing 'd' Nothing))))
...
keywords :: [String]
keywords = ["true", "false", "not", "sign", "if", "then", "do", "for", "lam", "while", "end"]
