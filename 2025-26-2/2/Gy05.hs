...
-- Asszertációs hiba
-- Üres lista hiba
data CustomError = DivByZero | AssertionError | EmptyList
  deriving (Eq, Show)
...
safeDivE _ 0 = throwError DivByZero
...
safeDivF x y = catchError (safeDivE x y) (const $ return 0)
